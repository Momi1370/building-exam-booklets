---
name: teaching-exam-sections
description: Use when a student wants a course section taught to them in conversation rather than turned into a document — section by section, from the professor's own materials — before a closed-book exam graded against model answers. Triggers include "teach me 4.1", "wear your teacher's clothes", "teach mode", "explain this section from scratch", "go through the module with me", "I've read it but I don't understand it".
---
...
This is the conversational sibling of the `building-exam-*` family. Those skills produce artifacts. This one runs a dialogue — and when the artifacts happen to exist, feeds back into them what the dialogue exposed.

**Two modes. Detect which one applies; don't interrogate the student about it.**

- **In sequence** — a booklet or an HTML study page already exists. Teach the section, then push the corrections the conversation surfaced back into that page, so it ends up carrying the student's own mistakes as traps.
- **Standalone** — nothing has been built yet, or the student simply doesn't want to work through the family in order. Teach straight from whatever documents they have: slide decks, lecture notes, transcripts, the assigned book chapter. **Never require the rest of the family as a prerequisite.** A student who says "just teach me chapter 4" gets chapter 4 taught, not a booklet build proposed.

## Core principle

**Source first, teach second. You must invent the case detail. You must never invent the course content.**

Before teaching a section, read the professor's own slides for it *and* the assigned chapter of the assigned book. Then teach with three things kept visibly separate: what **she** said, what the **book** said, and what is your own illustration. In an exam graded against model answers, the framework's own vocabulary is what scores, so a student who cannot tell your example apart from her definition cannot defend the answer.

The corollary: if the materials don't cover something, say so out loud rather than filling the gap from general knowledge.
...
Roughly in this order. Not a template to fill mechanically — sections differ — but if one of these is missing, know why.

- Where it sits in the course, and why the slide exists at all
- The definitions, verbatim, professor's and book's
- What each term does **not** mean (the everyday-sense trap)
- The professor's own worked example, in full
- The traps, stated as rules the student can apply, not as warnings
- The link forward: which later section this one is the instrument for
- One drill with a real answer key, then stop

## Common mistakes

- **Teaching from memory because the section seems simple.** Frameworks with four named dimensions are exactly where a plausible-sounding invented definition survives unnoticed.
- **Continuing to the next section while a structural misunderstanding is live.** A student who has merged two opposite categories into one sequence will carry it into every section built on top. Stop and fix it, even when they've asked to move on.
